...
var third:int
var combination=[]
const DOORCODE_1 = preload("res://Sprites/doorcode/doorcode1.png")
const DOORCODE_2 = preload("res://Sprites/doorcode/doorcode2.png")
const DOORCODE_3 = preload("res://Sprites/doorcode/doorcode3.png")
